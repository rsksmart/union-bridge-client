...
./cli-operations.sh user pegin --address 0x742d35Cc6634C0532925a3b844Bc9e7595f0bEb --satoshis 2000000 --protocol-version 7 --env local --execute
...
./cli-operations.sh user pegin --address 0x742d35... --rsk-address 1000000 --packet-number 0 --env alphanet

# Create pegin transaction and execute wallet command automatically
./cli-operations.sh user pegin --address 0x742d35... --rsk-address 1000000 --packet-number 0 --env alphanet --execute
