...
//! ```bash
//! cargo run -- user reject-pegin --committee-id 182376596843486060923694608664362585331 --member-index 1 --request-pegin-txid 0x4e80f8119c7299ae9d85adad5f0a45baa69831069046569ef4ba9574249ee471 --env local
//! ```
...
enum UserCommands {
    ...
    RejectPegin {
        ...
        /// Required on regtest/alphanet/testnet. Optional on local/local-docker (defaults to operator 1).
        #[arg(
            short = 'o',
            long = "operator-id",
            value_name = "OPERATOR_ID",
