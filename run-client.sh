...
set_multi_client_env() {
    ...
    var_name="STORAGE_PATH_$ID" && export UB__COORDINATOR__STORAGE_PATH="${BASE_STORAGE_PATH}/.union_bridge/database/${!var_name}"
    var_name="KEY_STORE_PATH_$ID" && export UB__TRANSACTION_DISPATCHER__KEY_STORE__USER_PATH="${BASE_STORAGE_PATH}/.union_bridge/keystore/${!var_name}-user"
    var_name="KEY_STORE_PATH_$ID" && export UB__TRANSACTION_DISPATCHER__KEY_STORE__MEMBER_PATH="${BASE_STORAGE_PATH}/.union_bridge/keystore/${!var_name}-member"
    var_name="SERVER_URL_$ID" && export UB__USER_API__SERVER__URL="${!var_name}"
    var_name="COORDINATOR_BROKER_CLIENT_ID_$ID" && export UB__USER_API__COORDINATOR_BROKER_CLIENT_ID="${!var_name}"
    var_name="BROKER_SERVER_PORT_$ID" && export UB__USER_API__BROKER_SERVER_PORT="${!var_name}"
    var_name="HTTP_SERVER_PORT_$ID" && export UB__USER_API__HTTP_SERVER_PORT="${!var_name}"
