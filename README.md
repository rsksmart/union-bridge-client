...
## 3. Fix Fairgate dependency access

Run the following command to configure Git to use your Fairgate GitHub token for accessing the Fairgate Labs (ask your colleagues about the token value)
```
git config --local url."https://${FAIRGATE_GITHUB_TOKEN}@github.com/FairgateLabs".insteadOf "https://github.com/FairgateLabs"
```
