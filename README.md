...
Clone Fairgate's [ZK Proof](ssh://git@github.com/FairgateLabs/rust-bitvmx-zk-proof/) repo, for now at `main` branch.
...
Please check the [ZKVM CLI documentation](ssh://git@github.com/FairgateLabs/rust-bitvmx-zk-proof/tree/main)
