...
# Script to configure the system before pegin (wallets, funding, operators)
#
# prerequisites:
...
#
# usage: bash tests/run-before-pegin.sh [--env <local|local-docker>]
...
log "Background mining: Anvil (every 1s) | Bitcoin (every 5s) - runs during setup"
echo ""
...
success "Setup complete - system ready for pegin"
