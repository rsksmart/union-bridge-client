...
pub fn convert_to_member_registration_keys(value: [CommitteePublicKey; 3]) -> Result<MemberRegistrationKeys, DomainErrors> {
    ...
    let communication_key_data = value.get(2)
    ...
    *rsa_array.get_mut(0)
        ...
        FixedBytes32::from_str(&communication_key_data.x)
