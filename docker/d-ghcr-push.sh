...
if [[ $DRY_RUN -eq 1 ]]; then
  ...
  echo "  docker tag ghcr.io/rsksmart/union-client-block-indexer:latest ghcr.io/rsksmart/union-client-block-indexer:$TAG"
  ...
  # Builder image is already tagged correctly
  docker push ghcr.io/rsksmart/union-client-builder:rust-1.86-v1

  # Tag and push other images with the specified tag
  docker tag ghcr.io/rsksmart/union-client-block-indexer:latest ghcr.io/rsksmart/union-client-block-indexer:$TAG
  ...
  docker tag ghcr.io/rsksmart/union-client-user-api:latest ghcr.io/rsksmart/union-client-user-api:$TAG
