...
Feature: Register peg-in request
  ...
  Scenario: Happy path
    ...
    And I POST "/register-pegin"
      ...
      | amount           | 100000                                                                                                                                           |
      | scriptPubKey0    | 0x5120228f281f297fd01cd363b9c93f742ba2976c1ec5a6083d9f754cb61e505356c3                                                                           |
  ...
  Scenario: Register peg-in request already registered
    ...
    And the response contains the error "AlreadyRegisteredPegInRequest"
  ...
  Scenario: Unsupported denomination
    ...
    # privKey: 0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80
    # KEY_STORE_PASSWORD=p09ol. RUST_BACKTRACE=1 RUST_LOG=debug cargo run --manifest-path /Users/javier/Projects/UnionBridge/union-bridge-monitor/transaction-dispatcher/Cargo.toml --bin transaction-dispatcher
    # curl -i -X POST http://localhost:3000/register-pegin \    -H "Content-Type: application/json" \    -d '{        "block_hash": "0x0000000000000000000282fa21665766e58eb6cb94e458c3ef6d4af1121e38d9",        "btc_tx": {            "version": 2,            "outputs": [{                "amount": 123456,                "script_pub_key": "0x5120228f281f297fd01cd363b9c93f742ba2976c1ec5a6083d9f754cb61e505356c3"            },{                "amount": 0,                "script_pub_key": "0x6a4552534b5f504547494e000000000000000070997970c51812dc3a010c7d01b50e0d17dc79c87d235c24420b2f55450c8414725aa74e6db01035245efdab0e1cfa7ab29aca0f"            }],            "inputs": [{                "tx_id": "0x360b81785dc7c2f40627fea364676dbb73e6276683caffd9f906b0e0bd36b3d2",                "v_out": 1694,                "sequence": 4294967293,                "script_sig": ""            }],            "lock_time": 0        },        "merkle_branch_path": "0xFF6B0000",        "merkle_branch_hashes": [            "0x3fcef4a1ddf759a858190b89ecbd1ff3dffb49704e110b68baf5b5de7021910f"        ]    }'
  ...
  Scenario: Wrong OP_RETURN (scriptPubKey - OUTPUT[1])
    ...
    # privKey: 0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80
    # KEY_STORE_PASSWORD=p09ol. RUST_BACKTRACE=1 RUST_LOG=debug cargo run --manifest-path /Users/javier/Projects/UnionBridge/union-bridge-monitor/transaction-dispatcher/Cargo.toml --bin transaction-dispatcher
    # curl -i -X POST http://localhost:3000/register-pegin \    -H "Content-Type: application/json" \    -d '{        "block_hash": "0x0000000000000000000282fa21665766e58eb6cb94e458c3ef6d4af1121e38d9",        "btc_tx": {            "version": 2,            "outputs": [{                "amount": 100000,                "script_pub_key": "0x5120228f281f297fd01cd363b9c93f742ba2976c1ec5a6083d9f754cb61e505356c3"            },{                "amount": 0,                "script_pub_key": "0x6b452534b5f504547494e000000000000000070997970c51812dc3a010c7d01b50e0d17dc79c87d235c24420b2f55450c8414725aa74e6db01035245efdab0e1cfa7ab29aca0f"            }],            "inputs": [{                "tx_id": "0x360b81785dc7c2f40627fea364676dbb73e6276683caffd9f906b0e0bd36b3d2",                "v_out": 1694,                "sequence": 4294967293,                "script_sig": ""            }],            "lock_time": 0        },        "merkle_branch_path": "0xFF6B0000",        "merkle_branch_hashes": [            "0x3fcef4a1ddf759a858190b89ecbd1ff3dffb49704e110b68baf5b5de7021910f"        ]    }'
    ...
    # privKey: 0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80
    # KEY_STORE_PASSWORD=p09ol. RUST_BACKTRACE=1 RUST_LOG=debug cargo run --manifest-path /Users/javier/Projects/UnionBridge/union-bridge-monitor/transaction-dispatcher/Cargo.toml --bin transaction-dispatcher
    # curl -i -X POST http://localhost:3000/register-pegin \    -H "Content-Type: application/json" \    -d '{        "block_hash": "0x0000000000000000000282fa21665766e58eb6cb94e458c3ef6d4af1121e38d9",        "btc_tx": {            "version": 2,            "outputs": [{                "amount": 100000,                "script_pub_key": "0x5120228f281f297fd01cd363b9c93f742ba2976c1ec5a6083d9f754cb61e505356c3"            },{                "amount": 0,                "script_pub_key": "0x6a4452534b5f504547494e000000000000000070997970c51812dc3a010c7d01b50e0d17dc79c87d235c24420b2f55450c8414725aa74e6db01035245efdab0e1cfa7ab29aca0f"            }],            "inputs": [{                "tx_id": "0x360b81785dc7c2f40627fea364676dbb73e6276683caffd9f906b0e0bd36b3d2",                "v_out": 1694,                "sequence": 4294967293,                "script_sig": ""            }],            "lock_time": 0        },        "merkle_branch_path": "0xFF6B0000",        "merkle_branch_hashes": [            "0x3fcef4a1ddf759a858190b89ecbd1ff3dffb49704e110b68baf5b5de7021910f"        ]    }'
