...
# cargo run --bin block_indexer_validator -- -t long-run-subs-blk-indxr
...
# cargo run --bin block_indexer_validator -- -t long-run-sync-blk-indxr
...
# cargo run --bin block_indexer_validator -- -t small-cache-blk-indxr
...
# cargo run --bin block_indexer_validator -- -t long-run-sync-large-cache-blk-indxr
