...
Feature: Coordinator - Peg in process
  ...
  Scenario: Happy path
    ...
    When bitvmx accepts a pegin request
      | file                    | block_hash                                                         | merkle_branch_path | merkle_branch_hashes                                               |  |
      | pegin_accept_happy_path | 0x5ec8021cc5f6474b479d07f2b5736cba3a894fcd0438099996846379bff35106 | 0x8325a0c5         | 0xcefbc931c000b2b2223e26472dae6ddafea0ace20a442f4ceefc61fe78f13f56 |  |
  ...
  Scenario: Unsupported denomination
    When bitvmx finds a pegin request
      | file                                   | block_hash                                                         | merkle_branch_path | merkle_branch_hashes                                               |  |
      | pegin_request_unsupported_denomination | 0x5ec8021cc5f6474b479d07f2b5736cba3a894fcd0438099996846379bff35106 | 0x8325a0c5         | 0xcefbc931c000b2b2223e26472dae6ddafea0ace20a442f4ceefc61fe78f13f56 |  |
    Then the pegin request should not be registered in the contract
    When enough confirmations are received
    Then the pegin request should not be registered in the coordinator
