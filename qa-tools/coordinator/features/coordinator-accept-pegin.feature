...
Feature: Coordinator - Accept Peg in process
  ...
  Scenario: Happy path
    ...
    # replace <REPLACE_WITH_peginRequestTxHash_FROM_PR_RESPONSE> in pa_happy_path.json with the actual pegin request tx hash from the response of the previous command
    # pa 0x5ec8021cc5f6474b479d07f2b5736cba3a894fcd0438099996846379bff35106 --btc-tx-file qa-tools/coordinator/fixtures/pa_happy_path.json 0x8325a0c5 0xcefbc931c000b2b2223e26472dae6ddafea0ace20a442f4ceefc61fe78f13f56
    # mine
