...
# Run log-indexer-validator
CMD="RUST_BACKTRACE=1 cargo run --bin log-indexer-validator -- -l $target_log_config_file -c $target_config_folder"
echo "Starting log-indexer-validator with command: $CMD"
eval "$CMD"