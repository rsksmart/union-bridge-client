...
#   COORDINATOR_METRICS_PORT=19101 scripts/metrics.sh

set -uo pipefail

HOST="${METRICS_HOST:-localhost}"
COORDINATOR_PORT="${COORDINATOR_METRICS_PORT:-9201}"
USER_API_PORT="${USER_API_METRICS_PORT:-9202}"
BLOCK_INDEXER_PORT="${BLOCK_INDEXER_METRICS_PORT:-9203}"
LOG_INDEXER_PORT="${LOG_INDEXER_METRICS_PORT:-9204}"
